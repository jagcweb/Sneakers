        ...
        <div class="filter">
            ...
            <div class="search-g open-div" id="search-orderby" onclick="changeText(event, 'orderby');">
                ...
                <label>
                    ...
                    <span>Cheaper to expensive</span>
                </label>
                <label>
                    <input type="radio" value="more-price" name="order">
                    <span>Expensive to cheaper</span>
                </label>
                <label>
                    <input type="radio" value="most-sold" name="order">
                    <span>Most sold to least sold</span>
                </label>
            </div>
        </div>
...
@if(count($products)>0)
<h1 class='titles2'>All our sneakers</h1>
@else
